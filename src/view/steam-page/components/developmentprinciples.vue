  ...
  <div class="app">
    <div class="famousteacher">
      ...
      <div class="class">
        <div class="text">
          <div class="title">
            <div class="menu" v-for="(items, index) in list" :key="(items, index)" @mouseenter="mouseenter(index)">
              <div class="icon">
...
export default {
  ...
  methods: {
    getmessage() {
      var that = this;
      Axios.get(
        "https://mock.aarnio.cn/mock/5e4a4a71a7e3066df43697b8/example/steamdevelopmentprinciples",
        {
          params: {}, // 参数
          timeout: 3000 // 配置
        }
