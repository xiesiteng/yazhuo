      ...
      <div class="class">
        <div class="box">
          <div class="middle">
            ...
            :style="{
              background:(index == choose?'#3855B1':''),
              width:(index == chose ? '300px':'220px'),
              }"
            >
              <div class="content"
              :style="{
              ...
              'align-items': (index == choose?'flex-start':'center'),
                  ...
                  >
                    ...
                    :style="{width: (index== choose?'136px':'46px'),
                    'text-align': (index == choose)?'start':'center'}"></div>
                  </div>
                </div>
                <div class="introduce"> 
                  ...
                  <div class="troduceanother" v-show="(index == choose)?true:false">
                    {{items.content}}
                  </div>
                </div>
...
export default {
  ...
  methods: {
    getmessage() {
      var that = this;
      Axios.get(
        "https://mock.aarnio.cn/mock/5e4a4a71a7e3066df43697b8/example/steamfunctionintroduction",
        {
          params: {}, // 参数
          timeout: 3000 // 配置
        }
