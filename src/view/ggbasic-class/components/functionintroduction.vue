...
export default {
  ...
  methods: {
    getmessage() {
      var that = this;
      Axios.get(
        "https://mock.aarnio.cn/mock/5e4a4a71a7e3066df43697b8/example/ggfunctionintroduction",
        {
          params: {}, // 参数
          timeout: 3000 // 配置
        }
...
.app {
  height: 472px;
  background-image: url(https://lxf-1256064321.cos.ap-chengdu.myqcloud.com/picture/%E4%B8%96%E7%95%8C%E5%9C%B0%E5%9B%BE%E8%83%8C%E6%99%AF.png);
